...
public class ScheduleCandidateService(FirestoreClient client, ScheduleVoteService voteService)
{
    ...
    {
        await voteService.DeleteForCandidateAsync(candidateId, ct);
        await client.DeleteDocumentAsync(Collection, candidateId, ct);
    }

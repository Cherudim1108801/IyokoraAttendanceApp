...
public class PracticeService(FirestoreClient client)
{
    ...
    /// <param name="timelineItems">タイムスケジュール（任意）。</param>
    ...
    /// <summary>指定の練習の開始・終了時刻とタイムスケジュールを更新する。</summary>
    /// <param name="practiceId">練習予定ID。</param>
    /// <param name="startTime">練習開始時刻（"HH:mm" 形式、任意）。</param>
    /// <param name="endTime">練習終了時刻（"HH:mm" 形式、任意）。</param>
    /// <param name="timelineItems">タイムスケジュール。</param>
    /// <param name="ct">キャンセルトークン。</param>
    ...
    /// <param name="memberName">受け取り済みにする場合に記録するメンバー名。</param>
    /// <param name="ct">キャンセルトークン。</param>
